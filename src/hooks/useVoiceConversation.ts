...
export const useVoiceConversation = () => {
  ...
  const getAgentResponse = async (
    ...
    const systemPrompt = `You are ${agent.name}, a ${agent.personality} AI assistant in the CTAS-7 Command Center.

Context from recent conversation:
${context}

Respond in character as ${agent.name}. Keep responses conversational, under 50 words, and actionable.
Current screen context: You have access to all CTAS systems - crates, metrics, DevOps, etc.
