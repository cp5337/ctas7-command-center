/**
 * CTAS Task Types with Dual Trivariate Hash Architecture
 *
 * CTAS 7.3.1 Specification: Dual Hash System
...
export interface HashGenerationRequest {
  ...
  task_data: Partial<CTASTask>; // Task data to hash
