...
class ApiService {
  ...
  async getCannonPlugs(): Promise<any> {
    const response = await fetch(`${API_BASE}/cannon/plugs`);
    return response.json();
  }

  async registerCannonPlug(plugData: any): Promise<any> {
    const response = await fetch(`${API_BASE}/cannon/plug`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  async connectCannonPlug(connectionData: any): Promise<any> {
    const response = await fetch(`${API_BASE}/cannon/connect`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  async routeToService(service: string, path: string = ''): Promise<any> {
    const response = await fetch(`${API_BASE}/route/${service}${path}`);
    return response.json();
  }

  async analyzeXSD(xsdData: any): Promise<any> {
    const response = await fetch(`${API_BASE}/xsd/analyze`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(xsdData)
    });
    return response.json();
  }

  async collectTelemetry(telemetryData: any): Promise<any> {
    const response = await fetch(`${API_BASE}/telemetry/collect`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
